...
class Info_kariera_sk:
    def __init__(self, file="res_kariera_sk.html"):
        self.__file = file
        self.link = f"https://kariera.zoznam.sk"
        self.vacancies = []
    ...
    def pars(self):
        ...
        for vac in soup.find_all("div", class_="offer"):
            try:
                title = vac.find("h2", class_="offer-title").text.strip()
            except:
                title = "None"
            print(title)
a =
